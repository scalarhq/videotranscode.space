!(function (e, t) {
  ...
  return (function (e) {
      ...
      e.exports = function () {
        ...
        var L = (function () {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (
                          h("info", "load ffmpeg-core"), (e.next = 4), x(p)
                        );
                      case 4:
                        (P = e.sent).setLogger(function (e) {
                          ...
                          null === S &&
                            (S = P.cwrap("proxy_main", "number", [
                              "number",
                              "number",
                            ])),
                          h("info", "ffmpeg-core loaded");
                      case 8:
                      case "end":
                        return e.stop();
                    }
          ...
          _ = function (e, t) {
            ...
            var r;
            return (
              h("info", "FS.".concat(e, " ").concat(t[0])),
              (r = P.FS)[e].apply(r, n(t))
            );
          },
          k = (function () {
            var e = a(
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        return (
                          (e.t2 = e.sent),
                          (e.t3 = [e.t1, e.t2]),
                          e.abrupt("return", (0, e.t0)("writeFile", e.t3))
                        );
                      case 7:
                      case "end":
                        return e.stop();
          ...
          M = function (e) {
            ...
            return (
              ...
              new Promise(function (r) {
                ...
                h("info", "ffmpeg command: ".concat(o.join(" "))),
                  (t = r),
                  S(o.length, g(P, o));
              })
            );
          ...
          D = function (e, t) {
            var r =
              arguments.length > 2 && void 0 !== arguments[2]
                ? arguments[2]
                : "";
            return M("-i ".concat(e, " ").concat(r, " ").concat(t));
          },
          N = function (e, t, r, n) {
            var o =
          ...
          I = function (e, t) {
            ...
            return (
              F("concat_list.txt", n),
              M(
                "-f concat -safe 0 -i concat_list.txt ".concat(r, " ").concat(t)
              )
            );
          };
        return {
      ...
      e.exports = function (e, t) {
        ...
        if ("string" == typeof r)
          if (r.startsWith("  Duration")) {
            ...
            t({ ratio: i(c) / o });
          } else r.startsWith("video:") && t({ ratio: 1 });
      };
    },
    function (e, t, r) {
      var n = r(12);
    ...
    function (e, t) {
      e.exports = function (e, t) {
        for (
          var r = e._malloc((t.length + 1) * Uint8Array.BYTES_PER_ELEMENT),
            n = 0;
          n < t.length;
          n += 1
        )
          e.setValue(r + n, t.charCodeAt(n), "i8");
        return e.setValue(r + t.length, 0, "i8"), r;
      };
    },
    function (e, t) {
      e.exports = function (e) {
        for (var t = [], r = 0, n = 0; (r = e.indexOf(" ", n)) >= 0; ) {
          ...
          if (0 === i || 0 === a) {
            ...
            if (u < 0)
              throw new Error(
                "Bad command escape sequence ".concat(c, " near ").concat(r)
              );
            ...
            if (l < 0)
              throw new Error(
                "Bad command escape sequence ".concat(s, " near ").concat(r)
              );
    ...
    function (e, t, r) {
      var n = r(15),
        o = r(18),
        i = r(19);
      e.exports = { defaultOptions: n, getModule: o, fetchFile: i };
    },
    function (e, t, r) {
      (function (t) {
        function n(e, t) {
        ...
        e.exports = (function (e) {
          ...
          corePath:
            void 0 !== t && "development" === t.env.FFMPEG_ENV
              ? i("/node_modules/@ffmpeg/core/ffmpeg-core.js")
              : "https://unpkg.com/@ffmpeg/core@v".concat(
                  a["@ffmpeg/core"].substring(1),
                  "/ffmpeg-core.js"
                ),
        });
      }.call(this, r(0)));
    ...
    function (e, t) {
      e.exports = { log: !1, logger: function () {}, progress: function () {} };
    },
    function (e, t, r) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        o("info", "fetch ffmpeg-core.worker.js script"),
                        (e.next = 5),
                        fetch(
                          r.replace("ffmpeg-core.js", "ffmpeg-core.worker.js")
                        )
                      );
                    case 5:
                    ...
                    case 7:
                      return (
                        (n = e.sent),
                        (window.FFMPEG_CORE_WORKER_SCRIPT = URL.createObjectURL(
                          n
                        )),
                        o(
                          "info",
                        ...
                        o(
                          "info",
                          "download ffmpeg-core script (~25 MB) from ".concat(r)
                        ),
                        e.abrupt(
                          "return",
                            ...
                            (t.src = r),
                              ...
                              t.addEventListener("load", function r() {
                                t.removeEventListener("load", r),
                                  o("info", "initialize ffmpeg-core"),
                                  (window.Module.onRuntimeInitialized = function () {
                                    o("info", "ffmpeg-core initialized"),
                                      e(window.Module);
                                  });
                              }),
                              document
                    ...
                    case 12:
                      return (
                        o("info", "ffmpeg-core is loaded already"),
                        e.abrupt("return", Promise.resolve(window.Module))
                      );
                    case 14:
                    case "end":
                      return e.stop();
