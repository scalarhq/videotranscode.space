...
var app = (function () {
    ...
    const clearTerminal = writable(false);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 77, 0, 2479);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h3 = element("h3");
    			h3.textContent = "Yes";
    			attr_dev(h1, "class", "title svelte-1w1bqsd");
    			add_location(h1, file$6, 34, 2, 514);
    			attr_dev(h3, "class", "format svelte-1w1bqsd");
    			add_location(h3, file$6, 36, 4, 577);
    			attr_dev(div0, "class", "configure svelte-1w1bqsd");
    			add_location(div0, file$6, 35, 2, 549);
    			add_location(div1, file$6, 33, 0, 506);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$7, 386, 16, 10524);
    			...
    			add_location(path1, file$7, 394, 16, 10968);
    			...
    			add_location(path2, file$7, 402, 16, 11334);
    			...
    			add_location(path3, file$7, 410, 16, 11742);
    			...
    			add_location(path4, file$7, 444, 14, 13029);
