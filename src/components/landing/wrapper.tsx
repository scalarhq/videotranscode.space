    ...
    <div id="wrapper">
      ...
      <Main>
        ...
        <Article
          ...
          alt="some image02"
          text={'<ul><li class="highlight-white"><b>100% private video manipulation(Videos never leaves your machine)</b></li><li class="highlight-white"><b>Much Lower Data Consumption(Max 25 MB)</b></li><li class="highlight-white">Convert video from any format</li><li class="highlight-white">Compress video</li><li class="highlight-white">Community Workflows!</li><li class="highlight-white">Complete Modular Design with CLUI</li><li class="highlight-white">Fully Open Source!</li></ul>'}
        />
